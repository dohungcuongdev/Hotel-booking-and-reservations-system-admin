        ...
        <div class="panel">
            ...
            <div class="box-tools m-b-15">
                <div class="input-group">
                    <input type="text" name="table_search" class="form-control input-sm pull-right"  style="width: 150px;" id="input-item" onkeyup="searchInputTable('input-item', 'table-restaurant')" placeholder="Search for names.." title="Type in a name"/>
